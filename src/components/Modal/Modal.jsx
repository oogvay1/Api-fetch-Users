    ...
    return (
        <div className="modal">
            <div className="Modal">
                <label>
                    <h1>Name:</h1>
                    <input type="text" name="name" placeholder="Name.." value={form.name} onChange={handle} autoComplete='off' />
                </label>
                <label>
                    <h1>Lastname:</h1>
                    <input type="text" name="lastname" placeholder="Lastname" value={form.lastname} onChange={handle} autoComplete='off' />
                </label>
                <label>
                    <h1>Age:</h1>
                    <input type="number" name="age" placeholder="Age" value={form.age} onChange={handle} autoComplete='off' />
                </label>
                ...
                <label>
                    <h1>Country:</h1>
                    <input type="text" name="country" placeholder="Country" value={form.country} onChange={handle} autoComplete='off' />
                </label>
                <label>
                    <h1>Is Developer:</h1>
                    <div className="radio">
